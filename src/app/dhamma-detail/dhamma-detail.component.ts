...
@Component({
  selector: 'app-dhamma-detail',
  templateUrl: './dhamma-detail.component.html',
  styleUrls: ['./dhamma-detail.component.css']
})
export class DhammaDetailComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get('assets/dhamma-deshana-detail.json')
  ...
  getDhammaUrl(dammaSummary: DhammaDeshanaDetail) {
