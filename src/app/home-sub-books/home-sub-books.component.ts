...
@Component({
  selector: 'app-home-sub-books',
  templateUrl: './home-sub-books.component.html',
  styleUrls: ['./home-sub-books.component.css']
})
export class HomeSubBooksComponent implements OnInit {
